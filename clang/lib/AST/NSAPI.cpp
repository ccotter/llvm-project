...
IdentifierInfo *NSAPI::getNSClassId(NSClassIdKindKind K) const {
  static std::array<const char *, NumClassIds>ClassName = { {
    "NSObject",
    "NSString",
    "NSArray",
    "NSMutableArray",
...
Selector NSAPI::getNSStringSelector(NSStringMethodKind MK) const {
  if (NSStringSelectors[MK].isNull()) {
    ...
    case NSStr_stringWithCStringEncoding: {
      ...
      Sel = Ctx.Selectors.getSelector(2, KeyIdents.begin());
      break;
    }
...
Selector NSAPI::getNSDictionarySelector(
  ...
  if (NSDictionarySelectors[MK].isNull()) {
    ...
    case NSDict_dictionaryWithObjectsForKeysCount: {
      ...
      Sel = Ctx.Selectors.getSelector(3, KeyIdents.begin());
      break;
    }
...
Selector NSAPI::getNSNumberLiteralSelector(NSNumberLiteralMethodKind MK,
                                           bool Instance) const {
  static std::array<const char *, NumNSNumberLiteralMethods>ClassSelectorName = { {
    "numberWithChar",
  ...
  static std::array<const char *, NumNSNumberLiteralMethods>InstanceSelectorName = { {
    "initWithChar",
  ...
  if (Instance) {
    ...
    Names = InstanceSelectorName.begin();
  } else {
    Sels = NSNumberClassSelectors;
    Names = ClassSelectorName.begin();
  }
