...
void modern() {
...

  {
    ...
    // CHECK-FIXES-NEXT: {{^    }}std::vector<std::string> t{"foo"s};
    // CHECK-FIXES-NEXT: {{^    }}std::vector<std::string> u;
    // CHECK-FIXES-NEXT: {{^    }}std::vector<std::string> a({"hey", "you"});
    // CHECK-FIXES-NEXT: {{^    }}std::vector<std::string> bb = {"h", "a"};
  }
}
